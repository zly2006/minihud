...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigDouble        ENTITY_DATA_SYNC_CACHE_TIMEOUT      = new ConfigDouble("entityDataSyncCacheTimeout", 1.0f, 0.25f, 5.0f, "minihud.config.generic.comment.entityDataSyncCacheTimeout").translatedName("minihud.config.generic.name.entityDataSyncCacheTimeout");
