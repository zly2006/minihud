...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigFloat         ENTITY_DATA_SYNC_CACHE_TIMEOUT      = new ConfigFloat("entityDataSyncCacheTimeout", 1.0f, 0.5f, 5.0f, "minihud.config.generic.comment.entityDataSyncCacheTimeout").translatedName("minihud.config.generic.name.entityDataSyncCacheTimeout");
